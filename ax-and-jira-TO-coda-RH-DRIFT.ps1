...
timeout 3
node load-ax --ax-file "C:\\code\\nodejs\\danbolig-project\\Project transactions_RH_DRIFT_Pending.xlsx"  --coda-token "83050ed5-ef90-4205-92d3-d53ede6cdd6e" --page-id "HBY9G8wcWz" --table-id "grid-pl6F0fpeZD" --ax-type pending
